    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="padding:10px">
                <form method="POST">
                    <h1 class="h3 mb-3 fw-normal">Incidence form</h1>
                ...
                <?php
                    if (isset($_POST['submit']) && isset($_POST['title']) && isset($_POST['description'])) {
                        ...
                        if($title != '' && $description != '' && $language_id != 'Select language') {
                            incidence::addIncidence($title, $description, $_SESSION['id'], $language_id);
                            echo "<div class='alert alert-success' role='alert'> ¡Your incidence has been published! </div>";
                        } else {
